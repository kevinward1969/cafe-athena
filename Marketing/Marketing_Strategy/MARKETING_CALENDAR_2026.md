...
| Date | Platform | Folio | Format | UTM | Notes |
|---|---|---|---|---|---|
| 2026-06-22 | Facebook | 06-07 | Recipe reel | ✗ | Posted without UTM — source unattributed in GA4 |
...
_Target: 4-week advance content buffer. Requires EXPO scheduled publishing (Technical Director) before EXPO posts can be queued._
...
_Target: Maintain 4-week buffer. First technique folio full stack live (all 5 assets). Pinterest Document Pin workflow confirmed._
...
_Q3 checkpoint: evaluate Facebook Group readiness (Instagram at 500 followers?)._
