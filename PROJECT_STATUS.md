...
| Add optional Variations section to recipe template | Recipes may have a dedicated ## Variations section (separate from Chef's Notes); Recipe-Format-Standard.md needs updating to define the section's scope, placement, and when it's required vs. optional | — | 2026-05-15 |
