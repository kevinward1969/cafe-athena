...
Last Updated: 2026-06-29 (session 2, evening)
...
| 06-04 | Nashville Hot Chicken — recipe reel campaign | ✅ Complete | Video produced by Kevin. Copy, UTM links, campaign file written. Instagram posted early (2026-06-29 — intended Jul 9). YouTube Short scheduled Jul 8 7am. Pinterest Video Pin scheduled Jul 13 9pm. Campaign file: `Marketing/Campaigns/2026/July/W1-Jul7-06-04-hot-chicken/copy.md`. Registry updated. Thumbnail still pending. |
...
| :--- | :--- | :--- | :--- |
| 06-04 thumbnail | YouTube and Pinterest both need a thumbnail before permanent scheduling URLs are available. Pinterest URL will resolve on Jul 13 post day. YouTube URL logged: `youtube.com/shorts/sVyPMq2-whs`. | Produce thumbnail; update registry `assets.thumbnail` and flip `ready: true` | 2026-06-29 |
| 06-04 copy approval | Instagram caption revised this session (crust given equal weight with glaze). Approved version is in registry and `copy.md` but Instagram post went live with earlier draft. | No action needed on live post — approved copy is on record | 2026-06-29 |
...
- **Instagram scheduling (2026-06-29):** Instagram has no direct browser scheduling for Reels. Must use Meta Business Suite or post manually. Kevin will calendar manual post dates going forward. Social scheduling automation (Postiz/Buffer/native tools) is deferred — see Pending New Work.
- **Campaign file convention (2026-06-29):** Each week's content gets a campaign folder at `Marketing/Campaigns/[YYYY]/[Month]/[W#-Mon##-folio-descriptor]/copy.md`. File holds channel copy, UTM links, post URLs, scheduled dates, and approval status. Registry (`marketing_content.json`) is the authoritative state; copy.md is the working doc.
