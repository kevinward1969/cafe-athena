...
| Chapter | Current | Target | Gap | Priority |
|---------|---------|--------|-----|----------|
...
| **Crab or lobster** | ❌ Missing | Premium shellfish absent |
| **Halibut** | ❌ Missing | Major white fish category missing |
...
| 05-06 | Shrimp — protocol-style (butter poach or bisque) | Original |
| 05-07 | Seared tuna — tataki or niçoise riff | Original |
| 05-08 | Mussels or clams — classic moules marinière or white wine | Original |
| 05-09 | Halibut — poached, roasted, or en papillote | Original |
| 05-10 | Crab or lobster — bisque, thermidor, or butter-poached | Original |
| 05-11 | Squid or octopus — braised, charred, or ink preparation | Original |
| 05-12 | Smoked fish technique — trout or mackerel | Original |
...
- 06-04 Nashville Hot Chicken (The Weissman Method)
- 06-05 Louisiana Blackened Chicken Pasta
...
| Chicken — fried/spiced | ✓ Covered | |
| Chicken — pasta | ✓ Covered | |
| Chicken — pie/pastry | ✓ Covered | |
| Duck — confit | ✓ Covered | |
...
| Pork | Thin (smoked steaks + bacon) | Only 2 pork preparations for a full chapter |
| **Lamb** | ❌ Missing entirely | Critical — the Butcher chapter has no lamb at all |
...
- 08-04 St. Louis Style Kisir (Red Hot Bulgur)
- 08-05 Modern Tabbouleh (The Acid Cutter)
- 08-06 Onion Potato Crisps
- 08-07 St. Louis "Riplet" Corn Ribs
...
| Mushroom | ✓ Covered |
| Squash | ✓ Covered (×2) |
| Root vegetables | ✓ Covered (×2) |
| Grains/wheat | ✓ Covered |
| Potato | ✓ Covered (×2) |
| **Brassicas** | ❌ Missing (Brussels sprouts, cauliflower, broccoli) |
...
| 08-12 | Southern greens — collards or mustard greens, pot likker method | `Southern Greens.pdf` |
...
## Cross-Chapter Category Gaps

These are taxonomy-level gaps identified by comparing browsable recipe categories against what the site can actually surface. The Taxonomy structure itself is correct — these are content gaps only. Each item notes the most logical chapter home.

| Category | Status | Logical Chapter | Note |
|----------|--------|----------------|------|
| Lamb | Partially addressed | Ch 7 — The Butcher | Covered in Ch 7 additions (07-14/07-15) |
| **Eggs** | ❌ Missing as featured dish | Ch 3 — Garde Manger | Deviled eggs exist (03-11) but no featured egg preparation (shakshuka, œufs en meurette, etc.) |
| **Soups as main dish** | Thin | Ch 6 — The Poulterer | Wedding soups exist but as named prep; no standalone soup category anchor (bisque, bouillabaisse, chowder) |
| **Noodles** | ❌ Missing | Ch 4 — The Mill | Ch 4 has pasta & risotto but no noodle dish (ramen, udon, soba, pad thai–style) — different technique and tradition |
| **Breakfast** | ❌ Missing | Ch 3 or cross-chapter | No breakfast-oriented category represented anywhere — eggs Benedict, pancakes, French toast, granola all unrepresented |
