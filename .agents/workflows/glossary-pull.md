...
3. Use Read to read the recipe document and extract the terms listed under the `### **Glossary**` heading at the bottom of the file. Note how each term is formatted (usually `* **Term:** Definition`).
4. Read the main glossary file at `The Manual/Café Athena  - Glossary.md` using the Read tool.
