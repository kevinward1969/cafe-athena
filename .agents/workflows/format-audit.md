...
6. Evaluate the document deeply against the template rules. Look specifically for:
   - **Vertical Order Validation:** Verify Title Block, Headnote, Mise En Place, Ingredients, Method, Notes, Glossary are all in the correct strict vertical succession.
