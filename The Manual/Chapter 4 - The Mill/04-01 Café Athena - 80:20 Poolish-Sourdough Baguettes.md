...
**Phase 5: Divide and Pre-Shape** Turn dough onto a floured surface immediately after the third fold. Divide into 4 equal pieces (~230 g each). **Shape:** Pat into a rectangle, then roll into a loose cylinder. **Rest:** Cover and bench rest for 15–20 minutes to relax the gluten.
...
**Phase 7: Proof and Retard** **Bench Proof:** Cover and proof at room temperature for 30–45 minutes until slightly puffy. **Cold Retard:** Move the couche (on a tray) to the refrigerator (38–40°F/3–4°C) for 8–12 hours.

**Phase 8: The Bake.** Boil water for the steam pan. Remove baguettes from the fridge. Gently transfer to a parchment-lined peel, seam-side down. **Score:** Use a lame to make 4–5 overlapping cuts at a 30–45° angle. **Load:** Slide onto the preheated steel (465°F/240°C). Add boiling water to the steam pan. **Cover:** Immediately cover loaves with an inverted roasting pan (optional, if your oven vents steam quickly). **Bake:** Bake with steam (or covered) for 12 minutes. Remove cover/vent steam. Bake exposed for 12–15 minutes until deep golden brown.
