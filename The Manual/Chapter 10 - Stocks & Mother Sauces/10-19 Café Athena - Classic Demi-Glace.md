# Café Athena - Classic Demi-Glace
...
The Demi-Glace is the halfway point between a sauce and a concentrate. By reducing equal parts Sauce Espagnole (Mother Sauce No. 3) and Brown Stock, we concentrate flavor and gelatin content, resulting in a glossy, sticky glaze that coats the palate. This is the "master sauce" from which most small brown sauces (Bordelaise, Chasseur, Robert) are born. **Teaching Idea: Reduction & Viscosity.** The goal here is not just evaporation, but texture modification. As water leaves the pot, the ratio of soluble protein (gelatin) to liquid increases, creating the signature "lip-sticking" quality of a true demi-glace.
...
3. **Establish the simmer:** Immediately reduce the heat to low. The liquid should be barely bubbling—a "lazy" simmer.
...
> Why: This removes any tiny particulates formed during reduction, ensuring a mirror-like finish.

1. **Cool or Hold:** If using immediately, keep warm in a bain-marie. If storing, cool rapidly in an ice bath before refrigerating.
