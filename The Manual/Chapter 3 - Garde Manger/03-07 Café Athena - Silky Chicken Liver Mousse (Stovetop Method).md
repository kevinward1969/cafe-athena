...
In a large skillet, melt the **30 g butter** over medium-high heat until foaming. Add the **cleaned livers** in a single layer. Do not overcrowd the pan (sear in batches if necessary). Sear for 2 minutes on the first side until browned. Flip and sear for 1 minute on the second side.

**Sensory Cue:** The livers should feel firm on the outside but squishy (like a rare steak) in the center. Add the **shallots**, **garlic**, and **thyme**. Cook for 1 minute until fragrant.

**Phase 2: The Deglaze**

Pour in the **Cognac**. CAUTION: The alcohol may flame if using a gas burner. Simmer rapidly until the liquid has reduced by half and the livers are just cooked through but still pink in the center.
...
Transfer the warm liver mixture (and all pan juices) into a blender. Add the **heavy cream**, **salt**, **pepper**, and **curing salt** (if using). Blend on high until completely liquified and smooth. With the blender running on low, drop in the **room temperature butter** one cube at a time.

**Why:** Adding fat slowly creates a stable emulsion, preventing the mixture from breaking (separating into oil and solid).
